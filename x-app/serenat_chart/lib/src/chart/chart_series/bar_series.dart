...
class BarSeries<T, D> extends XyDataSeries<T, D> {
  ...
  void customizeSegment(ChartSegment segment) {
    ...
    barSegment.color = segment.series._seriesColor;
    barSegment.strokeColor = segment.series.borderColor;
    barSegment.strokeWidth = segment.series.borderWidth;
