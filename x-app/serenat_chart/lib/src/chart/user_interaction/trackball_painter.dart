...
class _TrackballPainter extends CustomPainter {
    ...
    if (chart.trackballBehavior.tooltipSettings.format != null) {
      ...
      labelValue = !cartesianSeries._seriesType.contains('range') &&
          ...
          : cartesianSeries._seriesType == 'hiloopenclose' ||
                  cartesianSeries._seriesType.contains('candle')
              ? 'High: ' +
                  _getLabelValue(highValue, cartesianSeries._yAxis).toString() +
                  '\n' +
                  'Low: ' +
                  _getLabelValue(lowValue, cartesianSeries._yAxis).toString() +
                  '\n' +
                  'Open: ' +
                  _getLabelValue(openValue, cartesianSeries._yAxis).toString() +
                  '\n' +
                  'Close: ' +
                  _getLabelValue(closeValue, cartesianSeries._yAxis).toString()
              : 'High: ' +
                  _getLabelValue(highValue, cartesianSeries._yAxis).toString() +
                  '\n' +
                  'Low: ' +
  ...
  void _addChartPointInfo(CartesianSeries<dynamic, dynamic> series, double xPos,
    ...
    pointInfo.header =
        getHeaderText(series._dataPoints[dataPointIndex], series);
