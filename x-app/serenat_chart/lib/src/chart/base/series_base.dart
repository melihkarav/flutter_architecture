      ...
      if (series.dataSource != null) {
        for (int pointIndex = 0;
          ...
          if (xVal != null) {
            ...
            final dynamic x = series._xAxis;
            final dynamic y = series._yAxis;
            dynamic xMin = x?.visibleMinimum;
            dynamic xMax = x?.visibleMaximum;
            final dynamic yMin = y?.visibleMinimum;
            final dynamic yMax = y?.visibleMaximum;
            dynamic xPointValue = xVal;
            if (x is DateTimeAxis) {
            ...
            if ((chart._chartState.initialRender &&
              ...
              if (series.lowValueMapper != null) {
                ...
                series._dataPoints[series._dataPoints.length - 1].low =
                    lowValue;
              }
              ...
              if (series._xAxis != null &&
                ...
                _findMinMaxValue(series._xAxis, series, currentPoint,
                    pointIndex, series.dataSource.length);
              }
            }
          }
