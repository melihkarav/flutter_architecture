...
class DataLabelSettings {
  ...
  void renderDataLabel(
      ...
      Canvas canvas,
      int labelIndex) {
    _calculateDataLabelPosition(series, point, labelIndex, chart);
    _drawDataLabel(canvas, series, chart, series.dataLabelSettings, point,
        labelIndex, animationController);
  }
}
