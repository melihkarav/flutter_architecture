...
void _calculateDataLabelPosition(XyDataSeries<dynamic, dynamic> series,
  ...
  series.dataLabelSettings._textStyle = series.dataLabelSettings.textStyle;
  dataLabelStyle = ChartTextStyle(
      color: dataLabel.textStyle.color,
  ...
  series.dataLabelSettings._textStyle = ChartTextStyle(
  ...
  if (point != null && point.isVisible && point.isGap != true) {
    ...
    final _ChartLocation markerPoint3 = _calculatePoint(
        ...
        series,
        rect);
    final ChartTextStyle font = (dataLabel._textStyle == null)
        ? ChartTextStyle()
        : dataLabel._textStyle;
    point.label = label;
    if (label.isNotEmpty) {
...
void _calculateDataLabelRegion(
  ...
  rect = ((index == 0 || index == series._dataPoints.length - 1) &&
